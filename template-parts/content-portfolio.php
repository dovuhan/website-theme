 ...
 * @package iori
 */
$iori_pfs_settings = get_post_meta( get_the_ID(), 'iori_pfs_settings', true );
		...
		<div class="row">
			...
			<div class="col-xl-3 col-lg-4">
				<div class="sidebar-author">
					...
					<!-- case button -->
					<a href="<?php echo esc_url( $iori_pfs_settings['pfs_btn_link'] ); ?>" class="btn btn-brand-1 hover-up"><?php echo esc_html($iori_pfs_settings['pfs_btn_text']); ?>
					</a>
					<!-- case button -->

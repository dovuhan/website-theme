...
class Nav_Menu_Images {
	...
	public function init() {
		...
		// Load admin file
		if ( is_admin() ) {
			require_once IORI_INC . 'modules/iori-nav-menu/inc/admin.php';
	...
	public function load_textdomain() {
		...
		if ( ! is_textdomain_loaded( 'iori' ) ) {
			load_plugin_textdomain( 'iori', false, dirname( __FILE__ ) . '/languages' );
		}
	}
	...
	public function deregister_menu_item_filter( $item_output, $item ) {
		...
		$removefilter( 'the_title', array( $this, 'menu_item_content' ), 15, 2 );
		$removefilter( 'wp_get_attachment_image_attributes', array( $this, 'menu_item_hover' ), 15, 2 );
		$removefilter( 'wp_get_attachment_image_attributes', array( $this, 'menu_item_active' ), 15, 2 );
		$removefilter( 'wp_get_attachment_image_attributes', array( $this, 'remove_responsive' ), 15, 2 );
